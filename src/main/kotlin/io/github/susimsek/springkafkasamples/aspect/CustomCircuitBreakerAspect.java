...
public class CustomCircuitBreakerAspect {
    ...
    @Around(
        value = "matchAnnotatedMethod(circuitBreakerAnnotation) && args(slowCallThresholdInMillis,..)",
        argNames = "joinPoint,circuitBreakerAnnotation,slowCallThresholdInMillis")
    public Object circuitBreakerAroundAdvice(ProceedingJoinPoint joinPoint,
                                             CircuitBreaker circuitBreakerAnnotation,
                                             Integer slowCallThresholdInMillis) {
        var circuitBreakerConfig = CircuitBreakerConfig.custom()
            ...
            .slowCallDurationThreshold(Duration.ofMillis(slowCallThresholdInMillis))
            .build();
    ...
    @SneakyThrows
    public Object fallback(Throwable ex) {
